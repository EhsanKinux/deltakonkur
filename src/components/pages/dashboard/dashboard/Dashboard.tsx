    ...
    <div className="flex flex-col justify-center">
      ...
      <div className="flex flex-col bg-slate-100 rounded-xl shadow-form pb-10 xl:pb-5 gap-8 mt-4">
        <div className="relative z-20 h-35 md:h-65 rounded-xl">
          <img src={profileCover} alt="profile cover" className="h-full w-full object-cover object-center rounded-t-xl" />
        </div>
        <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-slate-500/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
          <div className="relative drop-shadow-2 flex items-center justify-center h-fit w-full">
            <img
              src="https://github.com/shadcn.png"
              alt={user ? getInitials(user.first_name, user.last_name) : "?"}
