...
export function AdvisorDetailContentTable({ columns, data }: AdvisorDetailContentTableProps) {
  ...
  //   ) {
  //     navigate(`/dashboard/content/advisors/${advisorId}`);
  //   }
  // };
      ...
      {/* <div className="flex flex-col items-center xl:flex-row gap-2 py-4">
        <div className="relative flex items-center w-full text-14 rounded-[8px]">
          ...
          <Input
            ...
            onChange={(event) => {table.setPageIndex(0);table.getColumn("first_name")?.setFilterValue(event.target.value)}}
        ...
        <div className="relative flex items-center w-full text-14 rounded-[8px]">
          ...
          <Input
            ...
            onChange={(event) => {table.setPageIndex(0);table.getColumn("last_name")?.setFilterValue(event.target.value)}}
            className="text-16 placeholder:text-16 rounded-[8px] text-gray-900 border-slate-400 placeholder:text-gray-500 hover:placeholder:text-blue-500"
          />
        </div>
      </div> */}
